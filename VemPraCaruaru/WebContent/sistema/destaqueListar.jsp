              ...
              try {
            	  ...
            	  for (Destaque destaque : destaques) {
	                ...
	                <tr id="<%=cssClasse%>">
	                  ...
	                  <td style="text-align:center;"><a href="destaqueListarDetalhes.jsp?id=<%=destaque.getId()%>" onclick="return hs.htmlExpand(this, { objectType: 'iframe', preserveContent: false, width: '650', height: '410'} )"><img src="../img/verDetalhes.png" alt="Visualizar detalhes do destaque de ID <%=destaque.getId()%>" title="Visualizar detalhes do destaque de ID <%=destaque.getId()%>" width="44" height="24"></a>&nbsp;<a href="destaqueAlterar.jsp?id=<%=destaque.getId()%>"><img src="../img/alterar.png" alt="Alterar o destaque de ID <%=destaque.getId()%>" title="Alterar o destaque de ID <%=destaque.getId()%>" width="24" height="24"></a>&nbsp;<a href="../DestaqueDeletar?id=<%=destaque.getId()%>" target="recebeForm" onClick="return doConfirm(this.id)"><img src="../img/deletar.png" alt="Deletar o destaque de ID <%=destaque.getId()%>" title="Deletar o destaque de ID <%=destaque.getId()%>" width="24" height="24"></a></td>
	                </tr>
	                <%        
            	  }
              } catch (Exception e) {
