...
try {
	...
	obras = Fachada.getInstance().obraListarTodos(" AND id_ponto_turistico='" + ponto.getId() + "' ");
} catch (Exception e) {
	e.printStackTrace();
}
%>
...
<body>
	<div id="detalhes">
		<h3>Obras do Ponto Tur&iacute;stico de ID <% out.print(request.getParameter("id")); %><br/><br/></h3>		
		<%if (obras.size() == 0) out.print("<br/><p>Não há obras cadastradas nesse ponto turístico</p>");
		for (Obra obra : obras) {%>
        <div>
