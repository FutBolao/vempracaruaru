...
<body>
	<div id="detalhes">
	  ...
	  <h3>Fotos do Ponto Tur&iacute;stico de ID 
        <%=ponto.getId() %></h3>
...
$(function () {
    ...
    var url = window.location.hostname === '../Upload?id=<%=ponto.getId() %>&referencia=ponto' ?
                '../Upload?id=<%=ponto.getId() %>&referencia=ponto' : '../Upload?id=<%=ponto.getId() %>&referencia=ponto';
