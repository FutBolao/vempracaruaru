...
$(function () {
    ...
    var url = window.location.hostname === '../Upload?id=<%=artista.getId() %>&referencia=artista' ?
                '../Upload?id=<%=artista.getId() %>&referencia=artista' : '../Upload?id=<%=artista.getId() %>&referencia=artista';
