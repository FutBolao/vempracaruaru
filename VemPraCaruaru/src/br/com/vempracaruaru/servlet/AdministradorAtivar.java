 ...
 */
@WebServlet("/AdministradorAtivar")
public class AdministradorAtivar extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdministradorAtivar() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
		    ...
		    if (id > 0){
		    	Fachada.getInstance().administradorAtivar(id);
		    	out.println( "<script>parent.alert(\"Administrador ativado com sucesso!\");</script>" );
			...
			e.printStackTrace();
			out.println( "<script>parent.alert(\"Ocorreu um erro inesperado ao ativar o administrador!\");</script>" );
		}
	}
