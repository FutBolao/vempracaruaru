 ...
 */
@WebServlet("/PontoInativar")
public class PontoInativar extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public PontoInativar() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
		    ...
		    if (id > 0){
		    	Fachada.getInstance().pontoTuristicoDeletar(id);
		    	out.println( "<script>parent.alert(\"Ponto Turístico inativado com sucesso!\");</script>" );
			...
			e.printStackTrace();
			out.println( "<script>parent.alert(\"Ocorreu um erro inesperado ao inativar o ponto turístico!\");</script>" );
		}
	}
