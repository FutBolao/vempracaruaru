 ...
 */
@WebServlet("/ArtistaInativar")
public class ArtistaInativar extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ArtistaInativar() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
		    ...
		    if (id > 0){
		    	Fachada.getInstance().artistaDeletar(id);
		    	out.println( "<script>parent.alert(\"Artista inativado com sucesso!\");</script>" );
			...
			e.printStackTrace();
			out.println( "<script>parent.alert(\"Ocorreu um erro inesperado ao inativar o artista!\");</script>" );
		}
	}
